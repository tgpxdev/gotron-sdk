...
var file_core_contract_storage_contract_proto_rawDesc = []byte{
	...
	0x6b, 0x65, 0x72, 0x61, 0x67, 0x65, 0x42, 0x9b, 0x01, 0x0a, 0x0c, 0x63, 0x6f, 0x6d, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x42, 0x14, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65,
...
func file_core_contract_storage_contract_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_core_contract_storage_contract_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_core_contract_storage_contract_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_core_contract_storage_contract_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_core_contract_storage_contract_proto_msgTypes[3].Exporter = func(v any, i int) any {
