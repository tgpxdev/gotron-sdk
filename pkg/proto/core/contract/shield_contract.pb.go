...
var file_core_contract_shield_contract_proto_rawDesc = []byte{
	...
	0x03, 0x52, 0x08, 0x74, 0x6f, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x9a, 0x01, 0x0a, 0x0c,
	0x63, 0x6f, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x42, 0x13, 0x53, 0x68,
	0x69, 0x65, 0x6c, 0x64, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x50, 0x72, 0x6f, 0x74,
	...
	0x65, 0x2f, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0xa2, 0x02, 0x03, 0x50, 0x58, 0x58,
...
func file_core_contract_shield_contract_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_core_contract_shield_contract_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_core_contract_shield_contract_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_core_contract_shield_contract_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_core_contract_shield_contract_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_core_contract_shield_contract_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_core_contract_shield_contract_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_core_contract_shield_contract_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_core_contract_shield_contract_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_core_contract_shield_contract_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_core_contract_shield_contract_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_core_contract_shield_contract_proto_msgTypes[10].Exporter = func(v any, i int) any {
